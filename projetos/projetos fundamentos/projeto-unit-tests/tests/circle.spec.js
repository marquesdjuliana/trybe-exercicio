...
describe('4 - Implemente os casos de teste para a função `circle`', () => {
  it('Verifica se ao receber um raio, a função `circle` retorna um objeto contendo os valores esperados', () => {
    ...
    expect(circle('oi')).toBeUndefined(); //Referêmcia: aprendi esse machter na função average, obrigada Trybe!
    // Teste se circle retorna um objeto.
    expect(typeof circle(5)).toEqual('object');
    // Teste se o objeto retornado possui 3 propriedades.
    const assignValue = circle(2);
    expect(Object.keys(assignValue).length).toBe(3);
    ...
    expect(circle(2).circumference).toBeCloseTo(12.56); // Referência pra esse matcher: https://github.com/facebook/jest/issues/5218
    ...
    // Referência doc: https://jestjs.io/pt-BR/docs/expect#tomatchobjectobject
